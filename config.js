module.exports = {
    ...
    server: {
        guildId: '1435043068955988149',         // ايدي السيرفر
        broadcastRoleId: '1435043424251285666', // ايدي الرول اللي يستخدم عليها البوت
        reportChannelId: '1438108498641551490' // ايدي الروم اللي يرسل فيه البوت التقارير
    },
    broadcast: {
